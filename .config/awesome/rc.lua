...
globalkeys = my_table.join(
	...
	end, { description = "show rofi", group = "hotkeys" }),
	...
	awful.key({ modkey }, "F2", function()
		awful.util.spawn(ide)
	end, { description = "tmux+nvim", group = "function keys" }),
	...
	awful.key({ modkey }, "F7", function()
		awful.util.spawn(virtualmachine)
	...
	awful.key({ modkey1, altkey }, "w", function()
		awful.spawn.with_shell("~/.screenlayout/laptop_disabled.sh")
	end, { description = "Disable laptop screen", group = "screen" }),
	awful.key({ modkey1, altkey }, "e", function()
		awful.spawn.with_shell("~/.screenlayout/laptop_only.sh")
	end, { description = "Laptop screen only", group = "screen" }),
	...
	awful.key({ modkey1, altkey }, "l", function()
		awful.util.spawn("i3lock -c 1a1a1a")
	end, { description = "lock screen", group = "alt+ctrl" }),
	awful.key({ modkey1, altkey }, "m", function()
		awful.util.spawn("systemsettings")
	end, { description = "KDE settings manager", group = "alt+ctrl" }),

	-- alt + ...
	-- screenshots
	awful.key({}, "Print", function()
		awful.util.spawn("scrot -s '%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'")
	...
	end, { description = "power menu (logout/restart/shutdown)", group = "awesome" }),
...
awful.rules.rules = {
	...
	{ rule = { class = "wpsoffice" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "gitkraken" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "google-chrome" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "wireshark" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "Wireshark" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "libreoffice" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "libreoffice-writer" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "libreoffice-calc" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "libreoffice-draw" }, properties = { maximized = false, floating = false } },
	{ rule = { class = "Gimp*", role = "gimp-image-window" }, properties = { maximized = false } },

	{ rule = { class = "Gnome-disks" }, properties = { maximized = false } },

	{ rule = { class = "inkscape" }, properties = { maximized = false } },

	{ rule = { class = mediaplayer }, properties = { maximized = false } },

	{ rule = { class = "Vlc" }, properties = { maximized = false } },
