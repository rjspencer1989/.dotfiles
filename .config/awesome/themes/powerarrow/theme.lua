...
theme.font = "Noto Sans Bold 20"
theme.taglist_font = "Noto Sans Bold 24"
theme.hotkeys_font = "Noto Sans Bold 18"
theme.hotkeys_description_font = "Noto Sans Bold 20"
theme.fg_normal = "#FEFEFE"
theme.fg_focus = "#7b88d3"
theme.fg_urgent = "#b74822"
theme.bg_normal = "#C44601"
theme.bg_focus = "#1E2320"
theme.bg_urgent = "#3F3F3F"
theme.taglist_fg_focus = "#7b88d3"
theme.tasklist_bg_focus = "#7b88d3"
...
function theme.at_screen_connect(s)
	...
	s.mywibox:setup({
		...
		{ -- Right widgets
			...
			arrow("#2546F0", "#5928ED"),
			wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#5928ED"),
			arrow("#5928ED", "alpha"),
			--]]
			s.mylayoutbox,
		},
